        ...
        <div className='container'>
          ...
          <div className='row'>
            <div className='col-lg-6'>
              ...
              <ModulesItem
                title='2. Función y estructura de las principales áreas de la adicción.'
              >
                <ul className='modules-list'>
                  <li>
              ...
              <ModulesItem
                title='3. Dinámica vincular temprana en los procesos adictivos: Trauma y desorganización.'
              >
                <ul className='modules-list'>
                  <li>
              ...
              <ModulesItem
                title='4. La adolescencia como dinámica evolutiva.'
              >
                <ul className='modules-list'>
                  <li>
              ...
              <ModulesItem
                title='5. Clínica y Apoyo farmacológico del Paciente.'
              />
            </div>
            <div className='col-lg-6'>
              <ModulesItem
                title='6. Modelo del desarrollo de la identidad desde una perspectiva Constructivista.'
              >
                <ul className='modules-list'>
                  <li>
              ...
              <ModulesItem
                title='8. Estrategias psicoterapéuticas desde el modelo Constructivista  y complejidad.'
              >
                <ul className='modules-list'>
                  <li>
