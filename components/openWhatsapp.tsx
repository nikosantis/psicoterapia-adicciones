...
type OpenWhatsAppProps = {
  active: boolean
  handleClose: () => void
  wsp: MutableRefObject<HTMLDivElement | null>
}

export default function OpenWhatsApp({ active, handleClose, wsp }: OpenWhatsAppProps) {
  if (active) {
    return (
      <Portal>
...
type WrapperProps = OpenWhatsAppProps

function Wrapper({ active, handleClose, wsp }: WrapperProps) {
