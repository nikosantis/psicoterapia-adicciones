      ...
      <div className='container'>
        <div className='row justify-content-center'>
          <div className='col-lg-7 text-center intro-title'>
            ...
            <h2 className='title'>Psicoterapia para el Tratamiento de abuso de alcohol y drogas</h2>
          </div>
          <div className='col-lg-8 text-center'>
            ...
            <p>Integrar cómo los procesos psicobiológicos, vinculares y ontogénicos (desarrollo vital) están a la base como probables detonantes de los procesos de adicción.</p>
